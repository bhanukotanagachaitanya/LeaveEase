...
import { FileCheck2, Search, Filter, CheckCircle2, XCircle, Calendar, User } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Review, search, and approve employee leave applications</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div>
            <select
              ...
              className="w-full px-3 py-2 rounded-xl border border-slate-300 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-brand-500 bg-white"
            >
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 shadow-subtle overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-xs text-slate-500 mt-1">Adjust search parameters or status filters</p>
          </div>
        ) : (
                  ...
                  <tr key={leave._id} className="hover:bg-slate-50/60 transition-colors">
                    <td className="py-4 px-6">
                      ...
                      <div className="text-[10px] text-slate-400 font-mono mt-0.5">
                        ID: {leave.employeeId?.employeeId} | {leave.employeeId?.department}
                      </div>
                    </td>
                    <td className="py-4 px-6 font-bold text-brand-800">{leave.leaveType}</td>
                    <td className="py-4 px-6">
